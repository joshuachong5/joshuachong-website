...
export function ProjectCard({ title, type, description, tags, href }: ProjectCardProps) {
  return (
    <article className="group rounded-[1.5rem] border border-slate-200 bg-white/80 p-6 shadow-[0_16px_40px_rgba(15,23,42,0.04)] transition-all duration-200 hover:-translate-y-1 hover:border-slate-300 hover:shadow-[0_22px_52px_rgba(15,23,42,0.08)]">
